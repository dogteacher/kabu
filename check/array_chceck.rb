...
p array.moving_average(4)
	#=> [nil, nil, nil, 105.75, 109.75, 116.25, 118.75, 119.75, 119.5 115.25]
p array.highs(3)
	#=> [nill ,nil, 111 ,115,116,123,123,123,121,119]
p array.lows(3)
	#=> [nil , nil ,97 , 97 , 111,115,119,115,110]
...
p average_changes
	#=> [nil , nil , nil, 5.0 ,6.333333333, 4.0 , 2.0 1.0 ,-2.6666666665 , -3.66666666665]
